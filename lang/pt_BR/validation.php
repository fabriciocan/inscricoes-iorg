...
return [
    ...
    | usadas pela classe de validação. Algumas dessas regras possuem
    | múltiplas versões, como as regras de tamanho. Sinta-se à vontade
    | para ajustar cada uma dessas mensagens aqui.
    |
    */
    ...
    | Isso facilita a especificação de uma mensagem de linguagem customizada
    ...
    */
    ...
    | de atributo por algo mais legível, como "Endereço de E-Mail" ao invés de
    | "email". Isso ajuda a tornar as mensagens mais expressivas.
    |
    */
