        ...
        @if ($package)
            <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div class="space-y-3 mb-6">
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Número do Pacote:</span>
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Total de Inscrições:</span>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <h3 class="font-semibold text-gray-900 mb-3">Inscrições:</h3>
                    <div class="space-y-2">
            ...
            <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <div class="flex items-start gap-3">
                    <x-heroicon-o-shield-check class="w-6 h-6 text-blue-600 flex-shrink-0 mt-0.5" />
